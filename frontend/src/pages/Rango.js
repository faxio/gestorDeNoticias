                        ...
                        return(
                            <div key={index}>
                                ...
                                <button className='boton8' onClick={async () => {
                                        await axios.delete(`http://217.71.206.44/api/solicitudes/${solicitud.nombre}?opcion=aceptar`).then(res => {toast({
                                ...
                                <button className='boton9' onClick={async () => {
                                    await axios.delete(`http://217.71.206.44/api/solicitudes/${solicitud.nombre}?opcion=denegar`).then(res => {toast({
